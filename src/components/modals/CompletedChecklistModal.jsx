...
// // import { useGetChecklistCommentsQuery, useReviveChecklistMutation, useUpdateChecklistStatusMutation, useUpdateCoCreatorChecklistMutation } from "../../api/checklistApi";
...
// //     console.log("Original checklist documents:", checklist.documents); // Debug log

// //     const flatDocs = checklist.documents.reduce((acc, item) => {
// //       if (item.docList && Array.isArray(item.docList) && item.docList.length) {
// //         console.log("Processing docList:", item.category, item.docList); // Debug log
...
// //     console.log("Flattened documents:", flatDocs); // Debug log
...
// //           onClick={async () => {
// //             try {
// //               const result = await reviveChecklist(checklist._id).unwrap();
              
// //               // Update the newly created copy's status to co_creator_review
// //               if (result?.checklist?._id) {
// //                 try {
// //                   await updateChecklistStatusMutation({
// //                     checklistId: result.checklist._id,
// //                     status: "co_creator_review"
// //                   }).unwrap();
// //                 } catch (statusError) {
// //                   console.error("Failed to update status, but revival was successful:", statusError);
// //                 }
// //               }
              
// //               message.success(`Checklist revived successfully as ${result?.checklist?.dclNo || 'new copy'}!`);
// //               onClose();
// //             } catch (error) {
// //               console.error("Revive error:", error);
// //               message.error(error?.data?.error || "Failed to revive checklist");
// //             }
// //           }}
// //           style={{
...
// //               </div>
// //               {/* <div style={{ fontWeight: "700", color: "#13c2c2" }}>
// //                 Approved: {documentCounts.approved}
// //               </div>
// //               <div style={{ fontWeight: "700", color: "#ff4d4f" }}>
// //                 Pending RM: {documentCounts.pendingrm}
// //               </div>
// //               <div style={{ fontWeight: "700", color: "#eb2f96" }}>
// //                 Pending Co: {documentCounts.pendingco}
// //               </div> */}
// //             </div>
...
//                         {"  •  "}
//                         {doc.fileSize || doc.uploadData?.fileSize
//                           ? formatFileSize( // ✅ USING THE NEW FUNCTION
//                               doc.fileSize || doc.uploadData?.fileSize,
//                             )
//                           : "N/A"}
//                       </div>
...
//     <Modal
//       title={
//         <div style={{ color: "white", fontWeight: "bold" }}> {/* ✅ UPDATED: Better title styling */}
...
//       onCancel={onClose}
//       width={1100}
//       styles={{ // ✅ ADDED: Modal header styling
//         header: {
...
//     >
//       {/* 🔹 VIEW DOCUMENTS BUTTON (ADDED) */}
//       <div className="doc-sidebar-toggle" style={{ marginBottom: 16 }}> {/* ✅ UPDATED: Added margin */}
//         <Button
//           icon={showDocumentSidebar ? <LeftOutlined /> : <RightOutlined />}
//           onClick={() => setShowDocumentSidebar(!showDocumentSidebar)}
//         >
...
//             size="small"
//             title={
//               <span style={{ color: PRIMARY_BLUE, fontSize: 14 }}> {/* ✅ UPDATED: Better title styling */}
//                 Checklist Details
//               </span>
//             }
//             style={{
//               marginBottom: 18,
//               borderRadius: 10, // ✅ UPDATED: Rounded corners
//               border: `1px solid #e0e0e0`, // ✅ UPDATED: Better border
//             }}
//           >
//             <Descriptions size="middle" column={{ xs: 1, sm: 2, lg: 3 }}> {/* ✅ UPDATED: Added size="middle" */}
//               <Descriptions.Item label="Customer Number">
//                 {checklist.customerNumber}
//               </Descriptions.Item>
//               <Descriptions.Item label="Loan Type">
...
//                 {checklist.assignedToCoChecker?.name || "Pending"}
//               </Descriptions.Item>
//               <Descriptions.Item label="Status"> {/* ✅ ADDED: Status field */}
//                 <Tag color="green">{checklist.status}</Tag>
//               </Descriptions.Item>
//               <Descriptions.Item label="Completed At"> {/* ✅ ADDED: Completed At */}
      ...
      {checklist && (
        <>
          ...
          >
            ...
            <Progress percent={progressPercent} status="active" />
            <div style={{ textAlign: "center", marginTop: "8px", fontWeight: "600", color: PRIMARY_BLUE }}>
              Checklist Complete - All documents processed
            </div>
          </div>
