...
//         (d) =>
//           d.isDCL ||
//           (d.name && /dcl/i.test(d.name)) ||
//           (selected.dclNo &&
//             d.name &&
//             d.name.toLowerCase().includes((selected.dclNo || "").toLowerCase()))
//       )) ||
//     [];
...
//     if (typeof v === "object")
//       return v.name || v.userName || v._id || JSON.stringify(v);
//     return v;
//   };
...
//           ? x.user
//           : x.user.name || JSON.stringify(x.user);
...
//       render: (d, r) => (
//         <Text>
//           {dayjs(r.updatedAt || r.approvedAt || r.updatedAt).format(
//             "DD MMM YYYY HH:mm"
//           )}
//         </Text>
//       ),
...
//       <Modal
//         title={
//           selected ? `Deferral Request: ${selected.deferralNumber}` : "Deferral"
//         }
//         open={modalOpen}
...
//                       color: PRIMARY_BLUE,
//                     }}
//                   >{`Deferral Request: ${selected.deferralNumber}`}</div>
...
//                     <Tag
//                       color={
//                         selected.category === "Allowable" ? "green" : "red"
//                       }
...
//                         <Tag color="blue">
//                           {selected.customerNumber || "N/A"}
//                         </Tag>
//                       </Descriptions.Item>
//                       <Descriptions.Item label="Loan Type">
//                         <div>{selected.loanType || "—"}</div>
//                       </Descriptions.Item>
//                       <Descriptions.Item label="Created At">
//                         <div>
//                           {dayjs(
//                             selected.createdAt || selected.requestedDate
...
//                         <div style={{ fontWeight: 700, color: PRIMARY_BLUE }}>
//                           {selected.deferralNumber}
//                         </div>
//                       </Descriptions.Item>
//                       <Descriptions.Item label="DCL No">
//                         {selected.dclNo || selected.dclNumber || (
...
//                           {selected.deferralTitle || selected.customerName}
//                         </div>
//                       </Descriptions.Item>
//                       <Descriptions.Item label="Loan Amount">
//                         {selected.loanAmount
//                           ? selected.loanAmount > 1000
//                             ? `KSh ${selected.loanAmount.toLocaleString()}`
//                             : `${selected.loanAmount} M`
//                           : "Not specified"}
//                         {selected.loanAmount && selected.loanAmount <= 75 && (
//                           <div
//                             style={{
//                               color: SUCCESS_GREEN,
//                               fontWeight: 700,
...
//                           {selected.daysSought || 0} days
//                         </div>
//                       </Descriptions.Item>
//                       <Descriptions.Item label="Next Due Date">
//                         {selected.nextDueDate
//                           ? dayjs(selected.nextDueDate).format("DD MMM YYYY")
//                           : "Not calculated"}
//                       </Descriptions.Item>
//                       <Descriptions.Item label="SLA Expiry">
//                         {selected.slaExpiry
//                           ? dayjs(selected.slaExpiry).format(
//                               "DD MMM YYYY HH:mm"
//                             )
//                           : "Not set"}
//                       </Descriptions.Item>
...
//                     {dclDocs.length === 0 ? (
//                       <div
//                         style={{ textAlign: "center", color: WARNING_ORANGE }}
//                       >
//                         No DCL document uploaded
//                       </div>
//                     ) : (
//                       <div>
...
//                         >
//                           <div
//                             style={{ fontWeight: 700, color: SUCCESS_GREEN }}
//                           >
//                             ✓ DCL document ready: {dclDocs[0].name}
//                           </div>
//                         </div>
//                       </div>
//                     )}
...
//                               d.name
//                                 .toLowerCase()
//                                 .includes((selected.dclNo || "").toLowerCase()))
//                           )
//                       ).length
//                     })`}
//                     style={{ marginTop: 12 }}
...
//                                   : ""}{" "}
//                                 {doc.uploadDate
//                                   ? `• Uploaded: ${dayjs(doc.uploadDate).format(
//                                       "DD MMM YYYY HH:mm"
//                                     )}`
//                                   : ""}
//                               </div>
...
//                       }}
//                     >
//                       {(selected.approverFlow || selected.approvers || []).map(
//                         (a, i) => {
//                           const isCurrent = (() => {
//                             if (
//                               typeof selected?.currentApproverIndex === "number"
//                             )
//                               return (
//                                 i === selected.currentApproverIndex &&
//                                 !(a && (a.approved || a.approved === true))
//                               );
...
//                                     }}
//                                   >
//                                     <ClockCircleOutlined /> Current Approver •
//                                     Pending Approval{" "}
//                                     {selected.slaExpiry && (
//                                       <span
//                                         style={{
...
//                             <div style={{ fontSize: 12, color: "#666" }}>
//                               {dayjs(h.date || h.createdAt).format(
//                                 "DD MMM YYYY HH:mm"
//                               )}
//                             </div>
      ...
      >
        <div style={{ padding: "16px 0" }}>
          ...
          <Card className="deferral-info-card" size="small" title={<span style={{ color: PRIMARY_BLUE }}>Customer Information</span>} style={{ marginBottom: 18, marginTop: 24 }}>
            <Descriptions size="middle" column={{ xs: 1, sm: 2, lg: 3 }}>
              <Descriptions.Item label="Customer Name">
                <Text strong style={{ color: PRIMARY_BLUE }}>{localDeferral.customerName}</Text>
              </Descriptions.Item>
              <Descriptions.Item label="Customer Number">
                <Text strong style={{ color: PRIMARY_BLUE }}>{localDeferral.customerNumber}</Text>
              </Descriptions.Item>
              <Descriptions.Item label="Loan Type">
                <Text strong style={{ color: PRIMARY_BLUE }}>{localDeferral.loanType}</Text>
              </Descriptions.Item>
              <Descriptions.Item label="Created At">
                <div>
          ...
          <Card className="deferral-info-card" size="small" title={<span style={{ color: PRIMARY_BLUE }}>Deferral Details</span>} style={{ marginBottom: 18 }}>
            <Descriptions size="middle" column={{ xs: 1, sm: 2, lg: 3 }}>
              <Descriptions.Item label="Deferral Number">
                <Text strong style={{ color: PRIMARY_BLUE }}>{localDeferral.deferralNumber}</Text>
              </Descriptions.Item>
              <Descriptions.Item label="DCL No">
                <Text strong style={{ color: PRIMARY_BLUE }}>{localDeferral.dclNo || localDeferral.dclNumber}</Text>
              </Descriptions.Item>
              <Descriptions.Item label="Status">
                {(() => {
                  ...
                  const isFullyApproved = hasCreatorApproved && hasCheckerApproved && allApproversApprovedLocal;
                  const isPartiallyApproved = (hasCreatorApproved || hasCheckerApproved || allApproversApprovedLocal) && !isFullyApproved;
                  const isRejected = status === 'deferral_rejected' || status === 'rejected' ||
                    localDeferral.deferralApprovalStatus === 'rejected';
                  const isReturned = status === 'returned_for_rework' || localDeferral.deferralApprovalStatus === 'returned';
                  ...
                  if (isFullyApproved) {
                    ...
                    return (
                      <div style={{ fontWeight: 500 }}>{(localDeferral.status || '').toLowerCase() === 'deferral_requested' ? 'Pending' : (localDeferral.status || '')}</div>
                    );
                  }
                })()}
              </Descriptions.Item>
              ...
              <Descriptions.Item label="Days Sought">
                <div style={{ fontWeight: 'bold', color: localDeferral.daysSought > 45 ? ERROR_RED : localDeferral.daysSought > 30 ? WARNING_ORANGE : PRIMARY_BLUE }}>
