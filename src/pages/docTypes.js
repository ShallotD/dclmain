...
export const loanTypeDocuments = {
  ...
  "Multiple Purpose Loan DCL": [
    ...
    },
    {
      title: "KYC Documents",
      documents: [
        "Borrower National ID / Passport",
        "Borrower PIN Certificate",
        "Guarantor ID / Passport & PIN (if applicable)",
        "Certificate of Incorporation / Business Registration (if applicable)",
        "CR12 / CR8 (if applicable)",
      ],
    },
    {
      title: "Security Documents",
      documents: [
        "Original Title Deed (where applicable)",
        "Certificate of Clean Title",
        "Post Registration Search",
        "Affidavit of Title",
        "Valuation Report from Approved Valuer",
        "Directors / Personal Guarantees (if applicable)",
      ],
    },
    {
      ...
      documents: [
        ...
        "Land Rates & Rent Receipts (if applicable)",
        "Comprehensive Insurance Cover",
        "Life / Business Loan Protection Insurance",
        "Updated CRB Report",
      ],
    },
  ],
