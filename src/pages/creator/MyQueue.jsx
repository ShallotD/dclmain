...
const Myqueue = () => {
  ...
  // const creatorId = user?._id; // or wherever you get it from
  ...
  const currentQueue = useMemo(() => {
    let filtered = allChecklists.filter((c) => {
      ...
      // Current queue should only include work coming from RM
      // Exclude revived checklists (they should only appear in Created Checklists For Review)
      if (isRevived) {
        return false;
      }
      
      return statusLower === "rm_review";
    });
