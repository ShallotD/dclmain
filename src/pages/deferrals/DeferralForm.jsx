...
//         }/api/users/customers/${selectedCustomerId}`;
...
//       const url = `${
//         import.meta.env.VITE_API_URL
//       }/api/users/customers?q=${encodeURIComponent(q)}${
...
//                 style={{
//                   color:
//                     firstApprover === "Pending" ? "#d9d9d9" : PRIMARY_PURPLE,
//                 }}
//               >
//                 {firstApprover}
//               </Text>
...
//           (async () => {
//             try {
//               await deferralApi.uploadDocument(newDeferral._id, dclFile, {
//                 isDCL: true,
//               });
//             } catch (e) {
...
//             (async () => {
//               try {
//                 await deferralApi.uploadDocument(newDeferral._id, f, {
//                   isAdditional: true,
//                 });
//               } catch (e) {
...
//       title={`Confirm submission to approver${
//         approverSlots.filter((s) => s.userId).length > 1 ? "s" : ""
//       }`}
